...
export const clearShortNameArray = (sortByParam) => 
    ...
    export const filterTransitionalTrays = (selectedKitchenId, searchText) => ((dispatch) => {
        dispatch({type:FILTER_TRANSITIONAL_TRAYS, selectedKitchenId, searchText})
    })